...
public class AddLevels implements Servlet {
	...
	public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
		System.out.println("start AddLevels >>");
		try {
			// -------------------------------------------------
			// パラメータの準備
			// -------------------------------------------------
			...
			String targetUrl = Constants.ADD_LEVELS_URL;
			...
			System.out.println("<< end AddLevels");
		}
