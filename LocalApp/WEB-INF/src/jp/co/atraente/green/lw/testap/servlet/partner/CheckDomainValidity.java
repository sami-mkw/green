package jp.co.atraente.green.lw.testap.servlet.partner;
...
public class CheckDomainValidity implements Servlet {
	...
	public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
		System.out.println(">> start CheckDomainValidity");
		try {
			// -------------------------------------------------
			// パラメータの準備
			// -------------------------------------------------
			...
			HttpPost request = new HttpPost("https://apis.worksmobile.com/r/jp1tqJKCjQwZi/partners/v1/domain/check-domain-validity");
			...
			System.out.println("<< end CheckDomainValidity");
		}
	}
}
