package jp.co.atraente.green.lw.testap.servlet.member;
...
public class RegistMember implements Servlet {
	...
	public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
		System.out.println("start RegistOrg >>");
		try {
			// -------------------------------------------------
			// パラメータの準備
			// -------------------------------------------------
			...
			String targetUrl = Constants.ORG_URL_PREFIX
					+ new String(req.getParameter("exKey").getBytes(Constants.UTF8), Constants.UTF8);
			...
			System.out.println("<< end RegistOrg");
		}
