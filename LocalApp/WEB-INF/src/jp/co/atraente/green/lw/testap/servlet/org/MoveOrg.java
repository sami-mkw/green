...
public class MoveOrg implements Servlet {
	...
	public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
		System.out.println("start MoveOrg >>");
		try {
			// -------------------------------------------------
			// パラメータの準備
			// -------------------------------------------------
			...
			String targetUrl = Constants.ORG_URL_PREFIX + req.getParameter("exKey") + "/move";
			...
			System.out.println("<< end MoveOrg");
		}
