...
<body>
	...
	<hr />
	<h2>BOT管理（管理画面から以外のもの）</h2>
	<h3>固定メニュー登録</h3>
	<form method="post" action="/app/v3/registBotMenu">
		<ul>
			<li style="list-style: none">[JSON]<br /> <textarea rows="15"
					cols="100" name="obj"></textarea></li>
			<li style="list-style: none"><button type='submit' name='action'>固定メニュー登録</button></li>
		</ul>
	</form>
	<h3>固定メニュー照会</h3>
