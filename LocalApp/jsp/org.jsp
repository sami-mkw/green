...
<body>
	...
	<h3>アカウント情報照会</h3>
	<form method="post" action="/app/getContact">
		<ul>
			<li style="list-style: none">[account] <input type="text"
				size="50" name="account"></input></li>
			<li style="list-style: none"><button type='submit' name='action'>アカウント情報照会</button></li>
			<li style="list-style: none">[JSON]<br /> <textarea rows="10"
					cols="100"><%=contact%></textarea></li>
		</ul>
	</form>
	<h3>職級追加</h3>
	<form method="post" action="/app/addLevels">
		<ul>
			<li style="list-style: none">[Request]<br /> <textarea
					rows="10" cols="100" name="obj"></textarea></li>
			<li style="list-style: none"><button type='submit' name='action'>職級追加</button></li>
			<li style="list-style: none">[Response]<br /> <textarea
					rows="10" cols="100"><%=level%></textarea></li>
		</ul>
	</form>
</body>
</html>