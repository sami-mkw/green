...
<body>
	...
	<hr />
	<h3>ユーザ情報</h3>
	<form method="post" action="/app/getUserInfo">
		<ul>
			<li style="list-style: none"><button type='submit' name='action'>情報取得</button></li>
